...
def draw():
    ...
    def node(x,y,w,h,lines):
        ax.add_patch(FancyBboxPatch((x-w/2,y-h/2),w,h,
            ...
            facecolor='#E8F2FE',edgecolor='#D5E5F7',linewidth=1.0,zorder=3))
        ax.text(x,y,lines,ha='center',va='center',fontsize=13,
                color='#2776BD',linespacing=1.6,zorder=4)
    ...
    node(10.25,y,2.20,.90,'$Z$：能力变换\n$\\operatorname{logit}(S/100)$')
    node(13.35,y,2.25,.90,'$S$：综合能力分\n六任务等权聚合')
    for a,b in [(2.50,3.23),(5.47,6.13),(8.37,9.13),(11.37,12.20)]:
        arrow([(a,y),(b,y)])
    node(4.35,4.50,2.20,.58,'$\\varepsilon_M$：规模扰动')
    node(10.25,4.50,2.65,.58,'$\\varepsilon_Y$：能力与评测扰动')
