...
def build(version='v0.9.0',include_cache=True):
    import re
    ...
    with tempfile.TemporaryDirectory(prefix='.package-',dir=ROOT) as tmp:
        ...
        names=NOTEBOOKS+MIRRORS+['run_all.py','repro_runtime.py','signal_cache.py','repro_inputs.json',
        ...
        for folder in ['output_q1/length_domain_calibrated22','output_q2_shared','output_q3_resource','output_q4_evolution','assets/fonts']:
        ...
        (package/'README.md').write_text((ROOT/'PACKAGE_README.md').read_text(encoding='utf-8').replace('v0.9.0',version),encoding='utf-8')
